      ...
      <section className="max-w-7xl mx-auto px-6 py-24 text-center">
        <div className="space-y-6 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            The fastest, safest web proxy. Access any website with our optimized
            infrastructure. Multiple tabs, full browser features, bookmarks, and
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Everything you need for fast, secure browsing
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="glass p-12 rounded-2xl border border-white/20 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Experience the Fastest Proxy?
          </h2>
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Create an account to save bookmarks, sync across devices, and unlock
            advanced features.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The fastest, safest web proxy on the internet.
              </p>
            </div>
            <div>
...
const features = [
  {
    ...
    description:
      "Optimized infrastructure delivers blazing-fast load times, even for large websites.",
    icon: <Zap className="w-6 h-6 text-white" />,
  },
  {
    title: "Completely Safe",
    description:
      "Military-grade encryption keeps your browsing secure and your data private.",
    icon: <Shield className="w-6 h-6 text-white" />,
  },
  {
    title: "Bank-Level Security",
    description:
      "Enterprise-grade security protocols protect against threats and malware.",
    icon: <Lock className="w-6 h-6 text-white" />,
  },
  {
    title: "Multiple Tabs",
    description:
      "Browse multiple sites simultaneously with our advanced tab management system.",
    icon: <Globe className="w-6 h-6 text-white" />,
  },
  {
    title: "Save Bookmarks",
    description:
      "Create an account to save and organize your favorite websites across devices.",
    icon: <BookmarkPlus className="w-6 h-6 text-white" />,
  },
  {
    title: "Full Browser Features",
    description:
      "Back/forward buttons, URL editing, fullscreen mode, and everything you expect.",
